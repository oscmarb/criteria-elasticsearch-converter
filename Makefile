...
build:
		docker build -t criteria-elasticsearch-converter .

erase: ## Remove the Docker containers of the project.
		docker rmi criteria-elasticsearch-converter

composer-install: ## Install composer dependencies
		docker run --rm -v .:/app criteria-elasticsearch-converter composer install

composer-update: ## Update composer dependencies
		docker run --rm -v .:/app criteria-elasticsearch-converter composer update

phpunit: ## Run PHPUnit
		docker run --rm -v .:/app criteria-elasticsearch-converter vendor/bin/phpunit tests
